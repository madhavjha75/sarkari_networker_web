...
//       // benefits
//       document.getElementById("banefits-1").innerText = post["banefits-one"];
//       document.getElementById("banefits-2").innerText = post["banefits-two"];
//       document.getElementById("banefits-3").innerText = post["banefits-three"];
//       document.getElementById("banefits-4").innerText = post["banefits-four"];
//       document.getElementById("banefits-5").innerText = post["banefits-five"];
